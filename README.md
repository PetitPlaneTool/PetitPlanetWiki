...
src/PetitPlanetTool.Package/AppPackages/
  └── PetitPlanetTool (Package)_0.1.0.0_x64_Test/
        ├── PetitPlanetTool (Package)_0.1.0.0_x64.msix   ← 安装包
...
```powershell
cd "src\PetitPlanetTool.Package\AppPackages\PetitPlanetTool (Package)_0.1.0.0_x64_Test"
...
也可在 **Actions → Release → Run workflow** 手动触发（填写版本号如 `0.1.0`）。

#### Release 产物

| 文件 | 说明 |
|------|------|
| `PetitPlanetWiki_0.1.0.0_x64.msix` | 已签名 MSIX 安装包 |
