...
src/PetitPlanetTool.Package/AppPackages/
  └── PetitPlanetTool (Package)_0.0.1.0_x64_Test/
        ├── PetitPlanetTool (Package)_0.0.1.0_x64.msix   ← 安装包
...
```powershell
cd "src\PetitPlanetTool.Package\AppPackages\PetitPlanetTool (Package)_0.0.1.0_x64_Test"
...
2. 推送标签触发发布：`git tag v0.0.1 && git push origin v0.0.1`
3. 或在 Actions 中手动运行 **Release** 工作流

**Release 产物：**

- `PetitPlanetWiki_0.0.1.0_x64.msix` — 已签名 MSIX
