...
src/PetitPlanetTool.Package/AppPackages/
  └── PetitPlanetTool (Package)_1.0.0.0_x64_Test/
        ├── PetitPlanetTool (Package)_1.0.0.0_x64.msix   ← 安装包
...
```powershell
cd "src\PetitPlanetTool.Package\AppPackages\PetitPlanetTool (Package)_1.0.0.0_x64_Test"
