...
; 在线版: ISCC /DMyAppVersion=0.1.11 installer\PetitPlanetWikiSetup.iss
; 离线版: ISCC /DMyAppVersion=0.1.11 /DEMBED_MSIX=1 /DOutputFileName=PetitPlanetWikiSetupFull installer\PetitPlanetWikiSetup.iss
